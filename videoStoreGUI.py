...
Author: Nikko Kapetanos 7/18/2023
...
class VideoStore(EasyFrame):
	...
	def __init__(self):
		EasyFrame.__init__(self, title = "Five Star Video", width = 300, height = 250, resizable = False, background = "lightyellow")
		...
		self.addLabel(text = "# of New Rentals:", row = 2, column = 0, sticky = "NSEW", background = "lightyellow", font = self.normalFont)
